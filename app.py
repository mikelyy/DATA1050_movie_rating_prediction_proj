# Code contributed and debugged by Yue Wang, Bangxi Xiao
import dash
import dash_table
...
index_page = html.Div([
    html.Header(
        html.Div(dcc.Link(html.Button('About this Project', style={'background-color': '#ADD8E6'}), href='/about'),
...
def update_output(n_clicks, value):
    ...
    new_page_layout = html.Div([
        ...
        html.Div(dcc.Graph(figure=tfig), style={'margin': 'auto'}),
